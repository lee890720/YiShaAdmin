...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.finance.loan.bankcard.list
    /// </summary>
    public class OapiFinanceLoanBankcardListRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiFinanceLoanBankcardListResponse>
    {
        /// <summary>
        /// 身份证号
        /// </summary>
