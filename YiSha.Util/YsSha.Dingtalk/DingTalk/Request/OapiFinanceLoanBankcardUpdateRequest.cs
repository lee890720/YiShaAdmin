...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.finance.loan.bankcard.update
    /// </summary>
    public class OapiFinanceLoanBankcardUpdateRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiFinanceLoanBankcardUpdateResponse>
    {
        /// <summary>
        /// 银行编码
        /// </summary>
