...
{
    /// <summary>
    /// TOP API: dingtalk.oapi.finance.loan.bankcard.add
    /// </summary>
    public class OapiFinanceLoanBankcardAddRequest : BaseDingTalkRequest<DingTalk.Api.Response.OapiFinanceLoanBankcardAddResponse>
    {
        /// <summary>
        /// 银行编码
        /// </summary>
