...
namespace YiSha.Service.OrganizationManage
{
    public class PositionService : RepositoryFactory
    {
        ...
        public async Task<PositionEntity> GetEntity(string positionName)
        {
            return await this.BaseRepository().FindEntity<PositionEntity>(p => p.PositionName == positionName);
        }
